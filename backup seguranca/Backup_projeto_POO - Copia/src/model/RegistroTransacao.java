...
public class RegistroTransacao {
	...
	public RegistroTransacao(int id, BigDecimal valor, String tipo, int tipoConta, LocalDateTime data) {
	    this.id = id;
	    this.valor = valor;
	    this.tipo = TipoTransacao.transacaoFromValor(Integer.parseInt(tipo));
	    this.tipo_conta = TipoConta.transacaoFromValor(tipoConta);
	    this.data = data;
	}
